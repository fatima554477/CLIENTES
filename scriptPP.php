...
$.ajax({
url:'comprobacionesVYO/fetch_pagesPP.php',
method:'POST',
...
$.ajax({
url:'comprobacionesVYO/VistaPreviapagoproveedor.php',
method:'POST',
...
var personal_id = $(this).attr('id');
$.ajax({
url:'comprobacionesVYO/VistaPreviaDatosBancario1.php',
method:'POST',
data:{personal_id:personal_id},
beforeSend:function(){
$('#mensajepagoproveedores').html('cargando');
...
const formData = new FormData($('#pagoaproveedoresform')[0]);
$.ajax({
url:'comprobacionesVYO/VistaPreviaNUEVOproveedor.php',
method:'POST',
data:{personal_id:personal_id},
beforeSend:function(){
$('#mensajepagoproveedores').html('cargando');
